...
Finite-state machine transducer / iterator with support for single lookahead value. Takes an object of `states` and their matchers, an arbitrary context object and an `initial` state ID (default: "start").

...
|  [\_\_serialize](./hdom.hdombehaviorattribs.__serialize.md) | <code>boolean</code> | Currently only used by . No relevance for hdom. If <code>false</code>, the element and its children will be omitted from the serialized result. |

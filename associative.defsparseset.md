...
[Home](./index.md) &gt; [@thi.ng/associative](./associative.md) &gt; [defSparseSet](./associative.defsparseset.md)

## defSparseSet variable
...
```typescript
defSparseSet: (n: number) => SparseSet8 | SparseSet16 | SparseSet32
```
